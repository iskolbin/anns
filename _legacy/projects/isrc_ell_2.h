...
#define N_POINTS_INT 100
#define N_POINTS_X0  40
#define N_POINTS_XPI 40
#define N_POINTS_Y0  20

int data[] = {
    PJ_INVERSE_UNKNOWN_SOURCE, PJ_ELLIPTIC_PROBLEM, 2, 0,

    FUNCTIOAL_SQUARE, 2, 5, 2, 0,

    N_POINTS_INT, 1,   // Уравнение переноса
    N_POINTS_X0, 0,   // x = 0
    N_POINTS_XPI, 0,   // x = pi
    N_POINTS_Y0, 0,   // y = 0
...
double delta[] = {
    1.0/N_POINTS_INT, 1.0/N_POINTS_X0, 1.0/N_POINTS_XPI, 1.0/N_POINTS_Y0, 1.0/PROBLEM_SENSORS};
